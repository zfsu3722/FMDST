...
class LSTM_No_site_Transformer(nn.Module):
    def __init__(self, input_dim=5, lstm_hidden_dim=32, transformer_hidden_dim=64,
        ...
        super(LSTM_No_site_Transformer, self).__init__()
        ...
        # Transformer Encoder Layer for learning relationships within features of each site
